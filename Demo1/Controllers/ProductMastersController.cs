...
namespace Demo1.Controllers
{
    public class ProductMastersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookId,BookName,BookCategory,BookPrice")] ProductMaster productMaster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookId,BookName,BookCategory,BookPrice")] ProductMaster productMaster)
        {
            if (ModelState.IsValid)
            {
